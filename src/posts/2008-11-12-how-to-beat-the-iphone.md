...
It should have one other feature: it should be able to act as a very short range
WAP using wifi, bluetooth, or usb.
...
same phone can be used to connect a laptop, a netbook, a PDA, or anything else.
